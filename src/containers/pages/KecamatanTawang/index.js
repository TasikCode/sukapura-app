...
import WartaTawang from '../../../components/molecules/WartaTawang';
import TawangChartSection from '../../../containers/organism/ScrollChartSection/TawangChartSection';

const KecamatanTawang = props => {
  return (
    <View style={{flex: 1}}>
      <StatusBar
      ...
      <Text
        ...
        KACAI JADI SALEUWI,KA DARAT JADI SALONGGAK
      </Text>
...
export default KecamatanTawang;
