...
import WartaPurbaratu from '../../../components/molecules/WartaPurbaratu';
import PurbaratuChartSection from '../../../containers/organism/ScrollChartSection/PurbaratuChartSection';

const KecamatanPurbaratu = props => {
  return (
    <View style={{flex: 1}}>
      <StatusBar
...
export default KecamatanPurbaratu;
