...
import WartaCihidueng from '../../../components/molecules/WartaCihideung';
import CihideungChartSection from '../../organism/ScrollChartSection/CihideungChartSection';

const KecamatanCihideung = props => {
  return (
    <View style={{flex: 1}}>
      <StatusBar
...
export default KecamatanCihideung;
